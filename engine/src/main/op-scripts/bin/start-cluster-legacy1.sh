...
raseRoot=/home/ielm/rase-legacy1
logDir=$raseRoot/logs

allLogDir=/home/ielm/rase-legacy1_log

version=$1
m2Dir=/home/ielm/m2/hk/ust/felab/rase-legacy1/$version
m2Dist=rase-legacy1-$version-bin.zip
